...
class TestNameType(object):
    ...
    def test_returns_all_names(self):
        ...
        #assert name1 and name2 and name3 in names
    ...
    def test_removes_names(self):
        ...
        name1b = name_type.get_or_add_name("name2", id_obj_2)
        name2 = name_type.get_or_add_name("name2", id_obj_2)
        #assert name1a and name1b in name_type.get_names("name1")
