...
def test_names():
    ...
    name1 = Name("1", NameType("1","type"), identified_object)
    name2 = Name("2", NameType("2","type"), identified_object)
    name3 = Name("3", NameType("3","type"), identified_object)
    duplicate1 = Name("1", NameType("1","type"), identified_object)
    ...
    assert identified_object.get_name("2", "type") == None
    ##return None from get_name(identified_object)
