...
class DiagramCimReader(BaseCimReader):
    ...
    def load_diagrams(self, table: TableDiagrams, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        diagram.diagramStyle = DiagramStyle[result_set.get_string(table.diagram_style.query_index)]
        diagram.orientationKind = OrientationKind[result_set.get_string(table.orientation_kind.query_index)]
    ...
    def load_diagram_objects(self, table: TableDiagramObjects, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        diagram_object.diagram = self._ensure_get(result_set.get_string(table.diagram_mrid.query_index), Diagram)
