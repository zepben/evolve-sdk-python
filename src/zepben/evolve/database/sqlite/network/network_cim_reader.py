...
class NetworkCimReader(BaseCimReader):
    ...
    def load_transformer_end_info(self, table: TableTransformerEndInfo, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        transformer_end_info.transformer_tank_info = self._ensure_get(result_set.get_string(table.transformer_tank_info_mrid.query_index), TransformerTankInfo)
        transformer_end_info.energised_end_no_load_tests = self._ensure_get(result_set.get_string(table.energised_end_no_load_tests.query_index), NoLoadTest)
        transformer_end_info.energised_end_short_circuit_tests = self._ensure_get(
            result_set.get_string(table.energised_end_short_circuit_tests.query_index),
            ShortCircuitTest
        )
        transformer_end_info.grounded_end_short_circuit_tests = self._ensure_get(
            result_set.get_string(table.grounded_end_short_circuit_tests.query_index),
            ShortCircuitTest
        )
        transformer_end_info.open_end_open_circuit_tests = self._ensure_get(
            result_set.get_string(table.open_end_open_circuit_tests.query_index),
            OpenCircuitTest
        )
        transformer_end_info.energised_end_open_circuit_tests = self._ensure_get(
            result_set.get_string(table.energised_end_open_circuit_tests.query_index),
            OpenCircuitTest
        )
    ...
    def load_transformer_tank_info(self, table: TableTransformerTankInfo, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        transformer_tank_info.power_transformer_info = self._ensure_get(
            result_set.get_string(table.power_transformer_info_mrid.query_index),
    ...
    def _load_asset(self, asset: Asset, table: TableAssets, result_set: ResultSet) -> bool:
        asset.location = self._ensure_get(result_set.get_string(table.location_mrid.query_index, on_none=None), Location)
    ...
    def load_streetlights(self, table: TableStreetlights, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        streetlight.pole = self._ensure_get(result_set.get_string(table.pole_mrid.query_index), Pole)
    ...
    def _load_end_device(self, end_device: EndDevice, table: TableEndDevices, result_set: ResultSet) -> bool:
        ...
        end_device.service_location = self._ensure_get(result_set.get_string(table.service_location_mrid.query_index, on_none=None), Location)
    ...
    def load_usage_points(self, table: TableUsagePoints, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        usage_point.usage_point_location = self._ensure_get(result_set.get_string(table.location_mrid.query_index, on_none=None), Location)
    ...
    def _load_auxiliary_equipment(self, auxiliary_equipment: AuxiliaryEquipment, table: TableAuxiliaryEquipment, result_set: ResultSet) -> bool:
        auxiliary_equipment.terminal = self._ensure_get(result_set.get_string(table.terminal_mrid.query_index, on_none=None), Terminal)
    ...
    def _load_conducting_equipment(self, conducting_equipment: ConductingEquipment, table: TableConductingEquipment, result_set: ResultSet) -> bool:
        conducting_equipment.base_voltage = self._ensure_get(result_set.get_string(table.base_voltage_mrid.query_index, on_none=None), BaseVoltage)
    ...
    def _load_equipment(self, equipment: Equipment, table: TableEquipment, result_set: ResultSet) -> bool:
        ...
        equipment.commissioned_date = result_set.get_instant(table.commissioned_date.query_index)
    ...
    def load_feeders(self, table: TableFeeders, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        feeder.normal_head_terminal = self._ensure_get(result_set.get_string(table.normal_head_terminal_mrid.query_index, on_none=None), Terminal)
    ...
    def _load_power_system_resource(self, power_system_resource: PowerSystemResource, table: TablePowerSystemResources, result_set: ResultSet) -> bool:
        power_system_resource.location = self._ensure_get(result_set.get_string(table.location_mrid.query_index, on_none=None), Location)
    ...
    def _load_measurement(self, measurement: Measurement, table: TableMeasurements, result_set: ResultSet) -> bool:
        ...
        measurement.remote_source = self._ensure_get(result_set.get_string(table.remote_source_mrid.query_index, on_none=None), RemoteSource)
        # todo terminalMrid
        measurement.terminalMrid = result_set.get_string(table.terminal_mrid.query_index, on_none=None)
        measurement.phases = PhaseCode[result_set.get_string(table.phases.query_index)]
        measurement.unitSymbol = UnitSymbol[result_set.get_string(table.unit_symbol.query_index)]

        if measurement.remote_source:
            measurement.remote_source = measurement
    ...
    def load_current_relays(self, table: TableCurrentRelays, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        current_relay.current_limit1 = result_set.get_float(table.current_limit_1.query_index, on_none=None)
        current_relay.inverse_time_flag = result_set.get_boolean(table.inverse_time_flag.query_index, on_none=None)
        current_relay.time_delay1 = result_set.get_float(table.time_delay_1.query_index, on_none=None)
    ...
    def _load_protection_relay_function(self,
        ...
        protection_relay_function.asset_info = self._ensure_get(result_set.get_string(table.relay_info_mrid.query_index, on_none=None), RelayInfo)
    ...
    def load_protection_relay_schemes(self, table: TableProtectionRelaySchemes, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        protection_relay_scheme.system = self._ensure_get(result_set.get_string(table.system_mrid.query_index), ProtectionRelaySystem)
    ...
    def load_remote_controls(self, table: TableRemoteControls, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        remote_control.control = self._ensure_get(result_set.get_string(table.control_mrid.query_index, on_none=None), Control)
    ...
    def _load_conductor(self, conductor: Conductor, table: TableConductors, result_set: ResultSet) -> bool:
        ...
        conductor.asset_info = self._ensure_get(result_set.get_string(table.wire_info_mrid.query_index, on_none=None), WireInfo)
    ...
    def load_energy_consumer_phases(self, table: TableEnergyConsumerPhases, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        energy_consumer_phase.energy_consumer = self._ensure_get(result_set.get_string(table.energy_consumer_mrid.query_index), EnergyConsumer)
    ...
    def load_energy_source_phases(self, table: TableEnergySourcePhases, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        energy_source_phase.energy_source = self._ensure_get(result_set.get_string(table.energy_source_mrid.query_index), EnergySource)
    ...
    def load_fuses(self, table: TableFuses, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        fuse.function = self._ensure_get(result_set.get_string(table.function_mrid.query_index), ProtectionRelayFunction)
    ...
    def load_power_electronics_connection_phases(
        ...
        power_electronics_connection_phase.power_electronics_connection = self._ensure_get(
            result_set.get_string(table.power_electronics_connection_mrid.query_index),
            PowerElectronicsConnection
        )
    ...
    def load_power_transformer_ends(self, table: TablePowerTransformerEnds, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        power_transformer_end.power_transformer = self._ensure_get(result_set.get_string(table.power_transformer_mrid.query_index), PowerTransformer)
    ...
    def _load_regulating_control(self, regulating_control: RegulatingControl, table: TableRegulatingControls, result_set: ResultSet) -> bool:
        ...
        regulating_control.terminal = self._ensure_get(result_set.get_string(table.terminal_mrid.query_index, on_none=None), Terminal)
    ...
    def _load_switch(self, switch: Switch, table: TableSwitches, result_set: ResultSet) -> bool:
        switch.asset_info = self._ensure_get(result_set.get_string(table.switch_info_mrid.query_index, on_none=None), SwitchInfo)
        switch.rated_current = result_set.get_int(table.rated_current.query_index, on_none=None)
        switch.normal_open = result_set.get_int(table.normal_open.query_index)
        switch.open = result_set.get_int(table.open.query_index)
    ...
    def _load_tap_changer(self, tap_changer: TapChanger, table: TableTapChangers, result_set: ResultSet) -> bool:
        ...
        tap_changer.tap_changer_control = self._ensure_get(result_set.get_string(table.tap_changer_control_mrid.query_index, on_none=None), TapChanger)
    ...
    def _load_transformer_end(self, transformer_end: TransformerEnd, table: TableTransformerEnds, result_set: ResultSet) -> bool:
        transformer_end.terminal = self._ensure_get(result_set.get_string(table.terminal_mrid.query_index, on_none=None), Terminal)
        transformer_end.base_voltage = self._ensure_get(result_set.get_string(table.base_voltage_mrid.query_index, on_none=None), BaseVoltage)
        ...
        transformer_end.star_impedance = self._ensure_get(result_set.get_string(table.star_impedance_mrid.query_index, on_none=None), TransformerStarImpedance)
    ...
    def load_circuits(self, table: TableCircuits, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        circuit.loop = self._ensure_get(result_set.get_string(table.loop_mrid.query_index, on_none=None), Loop)
        if circuit.loop:
    ...
    def load_lv_feeders(self, table: TableLvFeeders, result_set: ResultSet, set_identifier: Callable[[str], str]) -> bool:
        ...
        lv_feeder.normal_head_terminal = self._ensure_get(result_set.get_string(table.normal_head_terminal_mrid.query_index, on_none=None), Terminal)
